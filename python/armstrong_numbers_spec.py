...
class ArmstrongNumbersTestCase(unittest.TestCase):
    ...
    def test_returns_a_list(self):
        """When you call find_armstrong_numbers, you should receive a list"""
        self.assertEqual(type(find_armstrong_numbers([10])), list)
    ...
    def test_to_8(self):
        """When you call find_armstrong_numbers, you should receive a list of armstrong numbers from 0 to 7"""
